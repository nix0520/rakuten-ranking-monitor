...
楽天市場の Bra / ショーツ関連17ジャンルの日次ランキングと、2つの核心ジャンルのリアルタイムランキングを追跡する静的サイトです。
...
- 09:50 / 10:00 / 10:10 / 10:30の観測による日榜の初回切替時刻、集計日、ページ更新時刻、順位変動、進出・退出商品の記録
- Bra核心榜（110854）とショーツ核心榜（110845）の上位100位を20分間隔で記録
- 7日 / 30日の順位スパークライン
...
- `Rakuten Ranking Daily Probe`: 09:50 / 10:00 / 10:10 JST、17ジャンル上位30位で日榜切替を観測
- `Rakuten Ranking Daily`: 10:30 JST、17ジャンル最大1000位を取得
- `Rakuten Ranking Realtime`: 20分間隔、2核心ジャンル上位100位を取得
